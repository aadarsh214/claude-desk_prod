    ...
    >
      ...
      <g filter="url(#shadow)">
        <path
          ...
          fill="url(#g)"
        />
        {/* Stylized 'a' monogram: ring + right stem */}
        <circle cx="30" cy="32" r="8.5" fill="#ffffff" fillOpacity="0.95" />
        <circle cx="30" cy="32" r="4.5" fill="url(#g)" />
        <rect x="36" y="24" width="5" height="20" rx="2.5" fill="#ffffff" fillOpacity="0.95" />
        <rect x="30" y="24" width="11" height="4" rx="2" fill="#ffffff" fillOpacity="0.95" />
      </g>
    </svg>
  );
};
